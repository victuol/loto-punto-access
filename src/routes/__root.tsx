...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Loto Punto — a cardless ATM interface using dynamic QR codes and mobile banking integration to bring affordable cash access back to U.S. banking deserts." },
      { name: "author", content: "Loto Punto" },
      ...
      { name: "apple-mobile-web-app-title", content: "Loto Punto" },
    ],
    links: [
